    ...
    <>
      <AnimatePresence>
        {open && (
          ...
          >
            <div
              className="relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden"
            ...
            >
              ...
              <div className="relative px-8 pt-14 pb-10 text-center">
                ...
                >
                  <div className="relative flex items-center justify-center gap-3" onClick={loginWithGoogle}>
                    <img
